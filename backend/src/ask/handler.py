...
_FALLBACK_ASK = (
    ...
    "legal aid.\n\n"
    "BREVITY (critical) — the user is often a scared grandmother who needs the "
    "answer fast. `answer_es` must be 2 to 4 short sentences, MAXIMUM 60 words. "
    "Use plain, warm Spanish at a 5th-grade reading level. NO legal jargon unless "
    "you immediately define it in 3 words or fewer in parentheses. If the topic "
    "needs more depth than 60 words, give the single most important fact in one "
    "sentence and add: 'Pregúntale a tu abogado para los detalles.' Long, "
    "paragraph-style answers are wrong — they don't help her. Imagine reading "
    "the answer aloud to a tired 70-year-old: if it's too long for that, cut it.\n\n"
